...
const steps = [
  {
    ...
    desc: "Pick from dozens of mobile-first templates designed for African markets.",
  },
  {
    icon: LayoutGrid,
    title: "Drag & Drop",
    desc: "Customize every element with our intuitive visual editor.",
  },
  {
    icon: Package,
    title: "Add Products",
    desc: "Upload products, set pricing, and manage inventory effortlessly.",
  },
  {
    icon: CreditCard,
    title: "Set Up Payments",
    desc: "Accept mobile money, cards, and bank transfers in minutes.",
  },
  {
    icon: Globe,
    title: "Publish & Sell",
    desc: "Go live with your own custom domain and start selling.",
  },
];
...
export default function AfrifyPage() {
  return (
    <PageLayout>
      <section className="py-24 md:py-32 bg-surface-sunken overflow-hidden">
        <div className="absolute top-24 left-6 z-40">
          <Link href="/tradehub" className="inline-flex items-center gap-2 text-sm font-medium text-foreground hover:text-secondary transition-colors px-4 py-2 rounded-lg bg-card border border-border hover:border-secondary shadow-sm">
        ...
        <div className="container text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-[1.1] mb-6">
              Your Store, <span className="text-gradient-orange">Your Way</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              Build a beautiful online store in minutes. Accept mobile money, manage orders, and grow your business —
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              From zero to live store in under 30 minutes
            </p>
          </div>
