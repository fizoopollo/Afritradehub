...
const mockCompanies = [
  {
    ...
    products: 45,
    description:
      "Premium African fabrics and textiles manufacturer with 20+ years of experience.",
  },
  {
    id: 2,
    ...
    reviews: 89,
    products: 23,
    description: "Leading solar energy equipment supplier across East Africa.",
  },
  {
    id: 3,
    name: "GhanaGreen Exports",
    ...
    products: 67,
    description:
      "Organic cocoa, shea butter, and agricultural products for global markets.",
  },
  {
    id: 4,
    name: "Cape Tech Industries",
    industry: "Technology",
    ...
    products: 18,
    description:
      "Cutting-edge tech hardware and IoT solutions for African businesses.",
  },
  {
    id: 5,
    name: "Addis Construction Materials",
  ...
  },
  {
    ...
    products: 52,
    description:
      "Leading food processing and packaging company in North Africa.",
  },
];
...
export default function TradehubPage() {
  ...
  const filtered = mockCompanies.filter((c) => {
    ...
    const matchesIndustry =
      selectedIndustry === "All Industries" || c.industry === selectedIndustry;
        ...
        <div className="container">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex gap-2">
              ...
              <Button variant="default" size="lg" className="h-14 px-8">
                Search
              </Button>
            </div>
          </div>
